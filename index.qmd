...
A thesis submitted for the degree of {{< meta degreetype >}} at the University of Ottawa, {{< meta affiliation >}}.
...
This thesis is written using Quarto with renv [@renv] to create a reproducible environment. All materials (including the data sets and source files) required to reproduce this document can be found at the Github repository [`github.com/youraccount/thesis`](https://github.com/youraccount/thesis).
...
{{< include _extensions/juliengamartin/biouOthesis/end_frontmatter.tex >}}
