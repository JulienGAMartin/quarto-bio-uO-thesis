...
output:
  ...
  #   theme:
  #     primary: "#6D1919"
  #   repo: https://github.com/ulyngs/bio_uO_down
  #   pandoc_args: "--lua-filter=scripts_and_filters/colour_and_highlight.lua"
  # bookdown::gitbook:
...
# the title for the references section is created by front-and-back-matter/99-references_heading.qmd, 
...
<!--
Include the create_chunk_options chunk above at the top of your index.qmd file
...
```{r ebook-welcome, child = 'front-and-back-matter/_welcome-ebook.qmd', eval=knitr::is_html_output()}
```
