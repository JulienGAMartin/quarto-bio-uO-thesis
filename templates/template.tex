...
% Use this template to produce a standard thesis that meets the uOttawa Biology requirements for DPhil submission
%
...
% As you can see from the line below, bio_uO_down uses the a4paper size, 
% and passes in the binding option from the YAML header in index.qmd:
...
% pandoc puts lists in 'tightlist' command when no space between bullet points in qmd file,
...
% If you've not used LaTeX before, I recommend just using pandoc for citations -- this is what's used unless you specific e.g. "citation_package: natbib" in index.qmd
...
% we are setting the title for the references section in front-and-back-matter/99-references_heading.qmd
