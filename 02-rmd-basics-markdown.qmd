...
In other words, there is no need to indent basic text in the qmd document (in fact, it might cause your text to do funny things if you do).
...
In your thesis, this will probably happen in **index.qmd** and/or as opening chunks in each of your chapters.
